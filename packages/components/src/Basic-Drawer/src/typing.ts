...
import type { ScrollContainerOptions } from '@/helpComponents/Container/index';
...
export type UseDrawerReturnType = [RegisterDrawerFn, ReturnMethodsDrawer];

export type UseDrawerInnerReturnType = [RegisterDrawerFn, ReturnInnerMethodsDrawer];
